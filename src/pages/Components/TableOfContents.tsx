import { Toc } from "../../components/toc/components/Toc";
...
export const TableOfContents = () => {
  ...
  return (
    <div>
      {ref && (
        <Toc headingSelector={["h1", "h2", "h3"]} contentSelector={ref} />
      )}
      <main className="content" ref={(ref) => setRef(ref)}>
        <div className="article-container container-lg">
          ...
          <article className="article-content js-toc-content">
            ...
            <p>The body has a top margin equal to the header height.</p>
            <p>
